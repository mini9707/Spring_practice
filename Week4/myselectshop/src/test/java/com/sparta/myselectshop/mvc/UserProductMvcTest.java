...
@WebMvcTest(
        controllers = {UserController.class, ProductController.class}, // 테스트할 컨트롤러 클래스
        excludeFilters = {
...
class UserProductMvcTest {
    ...
    @BeforeEach // 테스트 코드가 실행되기 전에 수행
    public void setup() {
        mvc = MockMvcBuilders.webAppContextSetup(context)
                .apply(springSecurity(new MockSpringSecurityFilter())) // 가짜 필터를 스프링 시큐리티에 담아서 apply !
                .build();
    }
